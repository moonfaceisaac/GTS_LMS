...
class PembayaranmuridAdmin extends StatefulWidget {
  final Murid murid;
  const PembayaranmuridAdmin({super.key, required this.murid});

  @override
  State<PembayaranmuridAdmin> createState() => _PembayaranmuridAdminState();
}

class _PembayaranmuridAdminState extends State<PembayaranmuridAdmin> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  IconButton(onPressed: (){
                    _databaseHelper.deletePembayaran(pembayaranmurid.id!);
                    _fetchPembayaranListByMurid(widget.murid.id);
